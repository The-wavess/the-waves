<template>
    <div id="pp">
       <div class="header_div font_small">
            ...
            <div id="header_p">
                ...
                <button class="te_button"> 特惠购票</button>
            </div>
 ...
 <div class="detail_div flex">
        <div class="body_div">
            ...
            <p class="font_smalls">天地灵气孕育出一颗能量巨大的混元珠，元始天尊将混元珠提炼成灵珠和魔丸，灵珠投胎为人，助周伐纣时可堪大用；而魔丸则会诞出魔王，为祸人间。元始天尊启动了天劫咒语，3年后天雷将会降临，摧毁魔丸。太乙受命将灵珠托生于陈塘关李靖家的儿子哪吒身上。然而阴差阳错，灵珠和魔丸竟然被掉包。本应是灵珠英雄的哪吒却成了混世大魔王。调皮捣蛋顽劣不堪的哪吒却徒有一颗做英雄的心。然而面对众人对魔丸的误解和即将来临的天雷的降临，哪吒是否命中注定会立地成魔？他将何去何从？</p>
            <div>
                <div class="far_div">
            ...
            <div class="flex font_small">
                <ul id="daoyan_img">
                    <p class="daoyan">导演</p>
                    <li id="daoyan_img"><img src="../../public/move_img/detail5.jpg" alt=""><p>饺子</p></li>
                ...
                <ul >
                    <div class="daoyan_img">
                     ...
                     <ul id="ul_li">
                    <li>
                        <img src="../../public/move_img/detail2.jpg" alt=""><p>吕燕婷</p>
                        <p class="nezha">饰：儿童哪吒</p>
                    </li>
                    <li>
                        <img src="../../public/move_img/detail3.jpg" alt=""><p>吕燕婷</p>
                        <p class="nezha">饰：少年哪吒</p>
                    </li>
                    <li>
                        <img src="../../public/move_img/detail4.jpg" alt=""><p>吕燕婷</p>
                        <p class="nezha">饰：敖丙</p>
                    </li>
                    <li>
                        <img src="../../public/move_img/detail5.jpg" alt=""><p>吕燕婷</p>
                        <p class="nezha">饰：李靖</p>
                    </li>
                </ul>
                </ul>
            </div>
        ...
        <div class="far_div">
            ...
            <div class="flex">
                <img class="mar_right" src="../../public/move_img/8_1.jpg" alt="">
                <div>
                <img src="../../public/move_img/8_2.jpg" alt="">
                <img src="../../public/move_img/8_3.jpg" alt="">
                <img src="../../public/move_img/8_4.jpg" alt="">
                <img src="../../public/move_img/8_5.jpg" alt="">
        ...
        <div class="right_div">
            ...
            <ul class="flex float_re">
                <li>
                    <img src="../../public/move_img/de_right1.jpg" alt="">
                    <div class="bg_18 span_color">1</div>
                </li>
                <li class="font_small">
                    <span>《哪吒之魔童降世》</span>
            ...
            <ul class="flex float_re">
                <li>
                    <img src="../../public/move_img/de_right1.jpg" alt="">
                    <div class="bg_18 span_color">2</div>
                </li>
                <li class="font_small">
                    <span>《哪吒之魔童降世》</span>
            ...
            <ul class="flex float_re">
                <li>
                    <img src="../../public/move_img/de_right1.jpg" alt="">
                    <div class="bg_18 span_color">3</div>
                </li>
                <li class="font_small">
                    <span>《哪吒之魔童降世》</span>
					...
					<ul class="xiang_ul">
						<li class="xiang_li">
							<img src="../../public/move_img/right_d1.jpg" >
							<a href="#">呆瓜兄弟</a>
							<p>5. <span>9</span></p>
						</li>
						<li class="xiang_li">
